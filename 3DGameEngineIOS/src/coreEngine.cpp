...
{
	SDL_Window* window = Window::Create(m_width, m_height, title);
    //unique_ptr<CoreEngine> core = unique_ptr<CoreEngine>(this);
    //SDL_iPhoneSetAnimationCallback(window, 1, update, core.get());
...
void CoreEngine::Run(void* param)
{
	m_isRunning = true;
